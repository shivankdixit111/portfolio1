    ...
    <section className='profile-section-achievements'>
         <h1 className='main-heading'>Achievements</h1> 
           <div>
            ...
            <span> <FaHandPointRight />Achieved <b style={{color:"green"}}>Knight</b> title in LeetCode with the contest rating of <b>1879</b> (top 5 % in leetcode community accross the globe) </span>  <br />
            <span> <FaHandPointRight /> Achieved <b style={{color:"green"}}>Pupil</b> title with maximum rating of <b>1332</b> in Codeforces </span>  <br />
            <span> <FaHandPointRight /> 4 <MdOutlineStar style={{color:"yellow"}}/> with maximum rating of <b>1939</b> in GeeksForGeeks </span> <br />
            <span> <FaHandPointRight /> 3 <MdOutlineStar style={{color:"yellow"}}/> with maximum rating of <b>1650</b> in CodeChef </span> <br />
